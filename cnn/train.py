...
x, y, _ = get_data('/home/fizzer/Enph353-Comp/cnn/aug_letters/')
...
with open("/home/fizzer/Enph353-Comp/cnn/model_saves_letter/" + model_save_name+ ".json", "w") as json_file:
    json_file.write(model_json)

conv_model.save_weights('/home/fizzer/Enph353-Comp/cnn/model_saves_letter/' + model_save_name + '.h5')
print('--model saved as: ' + model_save_name + "--")


##INFER:
x_infer, y_infer, y_raw = get_data('/home/fizzer/Enph353-Comp/cnn/aug_letters')
